export default class CountryModule{
  ...
  render(){
    ...
    div.className = "col-md-4 border p-2 bg-info";
...
// עדיף לכתוב לפני הקלאס כמו שכתבנו בשורה 1
// מייצא את המחלקה כך שנוכל לייבא אותה
// export default - ניתן פעם אחת פר קובץ לעבוד
